...
var Permissions = function(options) {
  ...
  var options = { method: 'POST',
    ...
    json: {"client_id": _config.client_id, "client_secret": _config.client_secret, "audience": _config.contxt_audience, "grant_type":"client_credentials"} };
  ...
  var _get_service_scope_mappings = function(bearer, callback) {
    ...
    var init = function(callback) {
        var options = { method: 'POST',
                        url: 'https://ndustrial.auth0.com/oauth/token',
                        headers: { 'content-type': 'application/json' },
                        json: {"client_id":config.get('client_id'),"client_secret": config.get('client_secret'),"audience":config.get('contxt_audience'),"grant_type":"client_credentials"} };
